window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function DashboardSection(_props) {
			...
			return (0, react.createElement)("div", { style: {
			...
			}), actionBtn("导入", false, () => void doDiscover(), discovering || !addUrl.trim())), (0, react.createElement)("div", { style: {
				display: "flex",
				alignItems: "center",
				gap: 8,
				flexWrap: "wrap"
			...
			} }, "若远程 Agent 需要鉴权,填入 token;导入与后续调用都会带上。token 会明文存入 a2a.json。"), discovering ? (0, react.createElement)("div", { style: {
				fontSize: 13,
				color: "var(--dsw-alias-label-tertiary, #999)"
				...
				gap: 8,
				marginTop: 2
			} }, actionBtn("连接", true, () => void doConnect(), busy?.startsWith("add-agent:") ?? false), actionBtn("取消", false, () => {
				setDiscovered(null);
				setAddUrl("");
			...
			}, `• ${s.name}${s.description ? ` — ${s.description}` : ""}`))) : null), serve.enabled ? executorNote(serve) : null, serve.enabled ? authControl(serve, busy, act, authInput, setAuthInput) : null) : null, tab === "in" ? (0, react.createElement)("div", { style: {
				display: "flex",
				flexDirection: "column",
				gap: 10
		...
		*/
		function executorNote(serve) {
			...
			if (kind === "dsh-agent") return (0, react.createElement)("div", { style: {
				fontSize: 12,
				color: "var(--dsw-alias-label-secondary, #666)",
			...
			if (kind === "none") return (0, react.createElement)("div", { style: {
				fontSize: 12,
		...
		*/
		function authControl(serve, busy, act, authInput, setAuthInput) {
			return (0, react.createElement)("div", { style: {
				...
				fontWeight: 600,
				color: "var(--dsw-alias-label-primary, #222)"
			} }, "入站鉴权"), stateDot(serve.authConfigured ? "connected" : "disabled"), (0, react.createElement)("span", { style: {
				fontSize: 12,
				color: serve.authConfigured ? "#2e7d32" : "#9e9e9e"
			} }, serve.authConfigured ? "已启用 Bearer 鉴权" : "未鉴权(任何客户端可调用)")), (0, react.createElement)("div", { style: {
				display: "flex",
				alignItems: "center",
				gap: 8,
				flexWrap: "wrap"
				...
				setAuthInput("");
			}, busy === "set-server-auth:") : null), (0, react.createElement)("div", { style: {
				fontSize: 11.5,
				color: "var(--dsw-alias-label-tertiary, #999)"
