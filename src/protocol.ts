 ...
 */
export type Part =
  | { text: string; raw?: never; url?: never; data?: never; mediaType?: string; filename?: string; metadata?: Record<string, unknown> }
  | { raw: string; text?: never; url?: never; data?: never; mediaType?: string; filename?: string; metadata?: Record<string, unknown> }
  | { url: string; text?: never; raw?: never; data?: never; mediaType?: string; filename?: string; metadata?: Record<string, unknown> }
  | { data: unknown; text?: never; raw?: never; url?: never; mediaType?: string; filename?: string; metadata?: Record<string, unknown> };
...
export type StreamResponse =
  ...
  | { statusUpdate: TaskStatusUpdateEvent; task?: never; message?: never; artifactUpdate?: never }
  | { artifactUpdate: TaskArtifactUpdateEvent; task?: never; message?: never; statusUpdate?: never };
...
export type SendMessageResponse =
  | { task: Task; message?: never }
  | { message: Message; task?: never };
...
export type SecurityScheme =
  ...
  | { type: 'http'; scheme: 'basic' | 'bearer' | 'digest'; bearerFormat?: string; description?: string }
